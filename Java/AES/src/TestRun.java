...
public class TestRun {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < key.length; i++) {
            ...
            for (int j = 0; j < key.length; j++) {
                System.out.print(Integer.toHexString(hexToBinary(state[i][j].charAt(0)) ^ hexToBinary(key[i][j].charAt(0))));
                System.out.print("");
                System.out.print(Integer.toHexString(hexToBinary(state[i][j].charAt(1)) ^ hexToBinary(key[i][j].charAt(1))));
                System.out.print(" | ");
            }
        }
