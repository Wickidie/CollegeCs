...
<body>
    <br>
    <div class="w3-cointainer".>
        <form class="w3-cell w3-panel w3-border w3-hover-border-green" action="User.php" method="post">
            <h2> Login </h2>
            ...
            <p> <button type="submit" class="w3-btn w3-green"> Sign in </button> </p>
        </form>
    </div>
</body>
</html>